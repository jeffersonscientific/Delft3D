...
cmake -S .\src\cmake -B build_all -D CONFIGURATION_TYPE:String=all -D BUILD_TYPE=Debug -D CMAKE_INSTALL_PREFIX=.\install_all\ -D CMAKE_TOOLCHAIN_FILE=.\build\generators\conan_toolchain.cmake