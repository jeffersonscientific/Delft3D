# Tarball
Please use the tarball containing the latest released version of the source code, located [here](https://oss.deltares.nl/en/web/delft3dfm/get-started#Download%20source%20code)
