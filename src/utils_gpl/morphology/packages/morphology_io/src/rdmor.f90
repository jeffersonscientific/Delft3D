...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: rdmor.f90 5834 2016-02-11 14:39:48Z jagers $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160126_PLIC_VOF_bankEROSION/src/utils_gpl/morphology/packages/morphology_io/src/rdmor.f90 $
!-------------------------------------------------------------------------------
...
!
    ...
    if (trim(versionstring) == '02.00') then
       ...
       do i = 1, size(mor_ptr%child_nodes)
          ...
          if (morbnd(j)%icond<0 .or. morbnd(j)%icond>7) then
