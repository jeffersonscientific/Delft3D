...
!-------------------------------------------------------------------------------
   ...
   integer, public, parameter              :: ST_CROSSSECTION = 15
   integer, public, parameter              :: ST_RUNUP_GAUGE  = 16
   integer, public, parameter              :: ST_SOURCESINK   = 17
   integer, public, parameter              :: ST_GATEGEN      = 18
   integer, public, parameter              :: ST_LATERAL      = 19

   integer, public, parameter              :: ST_MAX_TYPE     = 19 !< Max id of structure types. The preceding ids must be lower than this.
