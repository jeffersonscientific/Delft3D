...
c History:
c $Log: normp.F,v $
c Revision 1.3  1996/06/07  11:56:46  kuipe_j
c multi  +  fixed layer
c
c Revision 1.2  1995/09/27  10:13:05  kuipe_j
c Maintenance
c
c
c***********************************************************************
...
c zorg dat de som van de p's 1 blijft
      gperr = 0 
      do 10 i=1,np
      it=0
      nf= nfa
cf    if(p(i,nfa).lt.1.0e-15) nf=nfa-1
