      subroutine SOGETR(fd_nefis, grpnam ,elmnam ,
...
c
c Module:             SOGETR (SObek GET Real variable)
c
c Module description: Allocate memory and read contents of variable into
c                     memory  (real pool). See chapter 6 of
...
c History:
c $Log: sogetr.pf,v $
c Revision 1.5  1999/03/15  15:19:52  kuipe_j
c tabs removed
c
c Revision 1.4  1995/09/22  10:04:18  kuipe_j
c variable dimensions, new headers
c
c Revision 1.3  1995/05/30  09:56:58  hoeks_a
c Minor changes
c
c Revision 1.2  1995/05/30  07:09:52  hoeks_a
c file changed from dos to ux
c
c Revision 1.1  1995/04/13  07:12:17  hoeks_a
c Initial check-in
c
c Revision 1.2  1993/11/26  15:09:57  kuipe_j
...
c
      ...
      integer      getrel, mkrpnt
      external     getrel, mkrpnt
c
...
c        Read the data
c
         errcod = getrel(fd_nefis, grpnam, elmnam,
