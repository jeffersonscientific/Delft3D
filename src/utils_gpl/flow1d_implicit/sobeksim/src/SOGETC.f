...
c
c Module:             SOGETC (SObek GET Character variable)
c
c Module description: Allocate memory and read contents of variable into
c                     memory (character pool). See chapter 6 of
...
c getcel  GET Character ELement from nefis file
...
c History:
c $Log: sogetc.pf,v $
c Revision 1.5  1999/03/15  15:19:49  kuipe_j
c tabs removed
c
c Revision 1.4  1995/09/22  10:04:13  kuipe_j
...
c Initial check-in
c
c Revision 1.2  1993/11/26  15:09:51  kuipe_j
