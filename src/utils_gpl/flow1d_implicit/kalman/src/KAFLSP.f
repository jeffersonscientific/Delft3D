...
c
c Module:             KAFLSP (Kalman Flow Structure correction Parameter)
c
c Module description: Remove correction on contraction coefficient of
c                     general structure due to uncertain correction
c                     parameter.
c
c                     Mu = Mu_cor / Pmu
c                     with:
...
c History:
c $Log: kaflsp.pf,v $
c Revision 1.3  1999/03/15  15:51:47  kuipe_j
c tabs removed
c
c Revision 1.2  1996/04/12  13:04:54  kuipe_j
c headers, minor changes
c
c Revision 1.1  1996/04/11  08:24:31  kuipe_j
