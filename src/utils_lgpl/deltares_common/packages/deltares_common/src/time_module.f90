module time_module
   ...
   !                                                                               
   !-------------------------------------------------------------------------------
   !  $Id: time_module.f90 5717 2016-01-12 11:35:24Z mourits $
   !  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160126_PLIC_VOF_bankEROSION/src/utils_lgpl/deltares_common/packages/deltares_common/src/time_module.f90 $
   !!--description-----------------------------------------------------------------
   !
   ...
   contains
      ...
      subroutine time_module_info(messages)
          ...
          !
          call addmessage(messages,'$Id: time_module.f90 5717 2016-01-12 11:35:24Z mourits $')
          call addmessage(messages,'$URL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160126_PLIC_VOF_bankEROSION/src/utils_lgpl/deltares_common/packages/deltares_common/src/time_module.f90 $')
