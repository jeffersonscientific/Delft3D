...
!!--declarations----------------------------------------------------------------
   ...
   integer, parameter, public :: CHKVAR_NOTCYCL = 0
   integer, parameter, public :: CHKVAR_CYCL = 1
   ...
   type tableparametertype
      ...
      integer :: cyclicity = CHKVAR_NOTCYCL
         ...
         if (inrange) then
            ...
            do i = 1, npar
               ...
               if (trim(table%parameters(j)%interpolation) == 'block') then
                  ...
                  !
                  if (table%parameters(j)%cyclicity == CHKVAR_NOTCYCL) then
