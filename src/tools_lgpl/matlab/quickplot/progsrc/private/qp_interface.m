...
voffset=voffset-25;
uicontrol('Parent',mfig, ...
    'Callback','d3d_qp climclip', ...
    'Enable','off', ...
    'Value',0, ...
    'HorizontalAlignment','left', ...
    'Position',[offset voffset width 20], ...
    'Style','checkbox', ...
    'String','Use Colour Limits to Clip', ...
    'Tag','climclip');
...
uicontrol('Parent',mfig, ...
    ...
    'Tag','threshdistr=?');
voffset=voffset-25;
h2 = uicontrol('Parent',mfig, ...
    'Enable','off', ...
    'HorizontalAlignment','left', ...
    'Position',[offset voffset 75 20], ...
    'Style','text', ...
    'String','Plot Classes', ...
    'Tag','plotclass', ...
    'UserData',0);
h1 = uicontrol('Parent',mfig, ...
    'Enable','on', ...
    'Callback','d3d_qp plotclass', ...
    'Position',[offset+75 voffset width-75 18], ...
    'Style','pushbutton', ...
    'String','Select', ...
    'Horizontalalignment','left', ...
    'Tag','plotclassbutton');
qp_tooltip(h1,'Click to select which classes to plot')
