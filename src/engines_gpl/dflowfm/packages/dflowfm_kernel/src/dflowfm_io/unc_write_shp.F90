...
subroutine unc_write_shp()
    ...
    use m_flowexternalforcings, only: nweirgen, ngategen, numsrc, ksrc, gate2cgen, L1cgensg, L2cgensg, npumpsg, L1pumpsg, L2pumpsg, ngenstru, genstru2cgen, weir2cgen, ndambreaklinks, ndambreaksg, L1dambreaksg, L2dambreaksg
    use m_thindams
