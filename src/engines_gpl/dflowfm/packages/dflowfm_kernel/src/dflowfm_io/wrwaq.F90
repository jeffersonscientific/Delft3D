...
!! timestep. At the last time a dummy record is written in .are and .flo.
   ...
   !! executable statements -------------------------------------------------------
      ...
      if (jawave == NO_WAVES .or. flowWithoutWaves) then ! If jawave > NO_WAVES, then taus is obtained from subroutine tauwave (taus = taucur + tauwave).
         call gettaus(1, 2)
      else
