   ...
   if (ndim == 0) then
    ...
    ! water quality bottom variables
      ...
      if (ndxi-ndx2d>0 .and. jaPure1D >= 3 .and. jamapPure1D_debug) then
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_q1d_1, nc_precision, UNC_LOC_U, 'q1d_1', '', 'q1d - from', 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_q1d_2, nc_precision, UNC_LOC_U, 'q1d_2', '', 'q1d - to'  , 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_au1d_1, nc_precision, UNC_LOC_U, 'au1d_1', '', 'au1d - from', 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_au1d_2, nc_precision, UNC_LOC_U, 'au1d_2', '', 'au1d - to'  , 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_wu1d_1, nc_precision, UNC_LOC_U, 'wu1d_1', '', 'wu1d - from', 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_wu1d_2, nc_precision, UNC_LOC_U, 'wu1d_2', '', 'wu1d - to'  , 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_sar1d_1, nc_precision, UNC_LOC_U, 'sar1d_1', '', 'sar1d - from', 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_sar1d_2, nc_precision, UNC_LOC_U, 'sar1d_2', '', 'sar1d - to'  , 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_alpha_mom_1d, nc_precision, UNC_LOC_S, 'alpha_mom_1d', '', 'alpha_mom_1d', 's', which_meshdim = 1, jabndnd=jabndnd_)
         ierr = unc_def_var_map(mapids%ncid, mapids%id_tsp, mapids%id_alpha_ene_1d, nc_precision, UNC_LOC_S, 'alpha_ene_1d', '', 'alpha_ene_1d', 's', which_meshdim = 1, jabndnd=jabndnd_)
      endif
