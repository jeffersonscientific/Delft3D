...
private
   ...
   integer, parameter, public :: UNC_LOC_GATE      = 26   !< Data location: his file gate datadata
   integer, parameter, public :: UNC_LOC_GATEGEN   = 42   !< Data location: his file gate datadata
