...
1234  continue
      ...
      elseif (NWHAT == 2) then
         ...
         else if (ndraw(28) == 45 .and. NUMCONST > 0) then
            if (NUMCONST > 0) then
               ndraw(28) = 1
               nwhat = 37
               goto 1234
         ...
         else if (ndraw(28) == numoptsf) then
            if (jasecflow > 0) then
               ndraw(28) = 1
         ...
         else if (ndraw(28) == numoptsed) then
            if (stm_included) then
               ndraw(28) = 1
