...
!     Temporary, copy normal stations to interpolated stations, dit mag hier blijkbaar niet op deze manier!
      
!      numadd = numobs
!      do iobs = 1, numadd 
!         L2         = index(namobs(iobs),' ') 
!         call addObservation(xobs(iobs), yobs(iobs), namobs(iobs)(1:L2-1)//'_interpolated')
!         intobs(numobs) = 1
!      end do
