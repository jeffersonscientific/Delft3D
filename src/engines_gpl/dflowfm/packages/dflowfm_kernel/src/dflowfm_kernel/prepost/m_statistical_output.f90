...
contains
   ...
   use m_structures
      ...
      if (jahiscgen > 0) then
         !if (ncgensg > 0) then
!           call add_stat_output_item(output_set, output_config%statout(IDX_HIS_GENERAL_STRUCTURE_DISCHARGE),valcgen(2,:)                 )
!           call add_stat_output_item(output_set, output_config%statout(IDX_HIS_GENERAL_STRUCTURE_CREST_LEVEL),            zcgen(1:3*ncgensg-2:3) )
!           call add_stat_output_item(output_set, output_config%statout(IDX_HIS_GENERAL_STRUCTURE_GATE_LOWER_EDGE_LEVEL),  zcgen(2:3*ncgensg-1:3) )
!           call add_stat_output_item(output_set, output_config%statout(IDX_HIS_GENERAL_STRUCTURE_GATE_OPENING_WIDTH),     zcgen(3:3*ncgensg:3)   )
!           call add_stat_output_item(output_set, output_config%statout(IDX_HIS_GENERAL_STRUCTURE_S1UP),valcgen(3,:)                               )
!           call add_stat_output_item(output_set, output_config%statout(IDX_HIS_GENERAL_STRUCTURE_S1DN),valcgen(4,:)                      )
         !endif
         if (ngenstru > 0) then
         ...
         if (jahispump > 0 .and. npumpsg > 0) then
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_STRUCTURE_DISCHARGE),valgenstru(IVAL_DIS       ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_CAPACITY           ),valgenstru(IVAL_PP_CAP    ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_DISCHARGE_DIR      ),valgenstru(IVAL_PP_DISDIR ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_S1UP               ),valgenstru(IVAL_S1UP      ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_S1DN               ),valgenstru(IVAL_S1DN      ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_STRUCTURE_HEAD     ),valgenstru(IVAL_PP_HEAD   ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_ACTUAL_STAGE       ),valgenstru(IVAL_PP_STAG   ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_HEAD               ),valgenstru(IVAL_PP_HEAD   ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_REDUCTION_FACTOR   ),valgenstru(IVAL_PP_RED    ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_S1_DELIVERY_SIDE   ),valgenstru(IVAL_PP_S1DEL  ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_PUMP_S1_SUCTION_SIDE    ),valgenstru(IVAL_PP_S1SUC  ,1:genstru))
         endif                                                                                          
         ...
         if (jahisweir > 0 .and. nweirgen > 0) then
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_DISCHARGE       ),valweirgen(IVAL_DIS       ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_CREST_LEVEL     ),valweirgen(IVAL_CRESTL    ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_CREST_WIDTH     ),valweirgen(IVAL_CRESTW    ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_S1UP            ),valweirgen(IVAL_S1UP      ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_S1DN            ),valweirgen(IVAL_S1DN      ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_STRUCTURE_HEAD  ),valweirgen(IVAL_HEAD      ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_VELOCITY        ),valweirgen(IVAL_VEL       ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_FLOW_AREA       ),valweirgen(IVAL_AREA      ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_STATE           ),valweirgen(IVAL_STATE     ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_FORCE_DIFFERENCE),valweirgen(IVAL_FORCEDIF  ,1:genstru))
            call add_stat_output_item(output_set, output_config%statout(IDX_HIS_WEIRGEN_S1_ON_CREST     ),valweirgen(IVAL_S1ONCREST ,1:genstru))
         endif
