...
!
   ...
   !!--declarations----------------------------------------------------------------
      ...
      use m_sediment, only: stmpar, sedtra, stm_included, mtd, jatranspvel, sbcx_raw, sbcy_raw, sswx_raw, sswy_raw, &
                            sbwx_raw, sbwy_raw, difparam, difcal
      ...
      use m_flow, only: s0, s1, u1, kmx, zws, hs, &
                        iturbulencemodel, z0urou, ifrcutp, hu, spirint, spiratx, spiraty, u_to_umain, frcu_mor, &
                        javeg, jabaptist, cfuhi, epshs, taubxu, epsz0
