subroutine VIRTUALlinkAVER_volum1(volum1,s1,dps,gsqsR,thick,NMlistMERGED,Nmerged,icx,icy,nmmax,nmlb,nmub,nst,kmax, dim_nmlist)
!
!----- GPL ---------------------------------------------------------------------
!                                                                               
...
!!--description-----------------------------------------------------------------
!
!   Function:   compute "spreaded"  volum1
!
...
!
RETURN
end subroutine VIRTUALlinkAVER_volum1
