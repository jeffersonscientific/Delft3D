subroutine BOUvelINT(kfumn0,kfumx0,dzu0,dzmin,thick,u1,qxk,momsol,kfu,circ3d,hu,aguu,guu,irocol,norow,icx,icy,nmmax,nmlb,nmub,kmax,nst,ddb,wavcmp,Zmodel,gdp) 
