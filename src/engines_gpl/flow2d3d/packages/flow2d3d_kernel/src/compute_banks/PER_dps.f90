subroutine PER_dps(dps, dzVECT, nlb, mlb, nub, mub, nrPER, gdp)  
!----- GPL ---------------------------------------------------------------------
!                                                                               
...
!
    ...
    !
    do k=1,nrPER  
       dps(nPQ_ext(k),mPQ_ext(k)) = dps(nPH_int(k),mPH_int(k)) - dzVECT(k)
       dps(nPH_ext(k),mPH_ext(k)) = dps(nPQ_int(k),mPQ_int(k)) + dzVECT(k)
    enddo
    !
end subroutine PER_dps
