...
contains
      ...
      integer(kind=int_32)                ::nfrac       ! I  number of fractions
      real(kind=sp)                ::flx         ! I  flux to be split
      real(kind=sp)                ::rfrac_p     ! I  relative fraction to be used for positive flux

      ! local variables

      integer(kind=int_32)                ::npnt        !    number of pointers in pmsa
      ...
      integer(kind=int_32)                ::ifrac       !    loop counter for fractions
