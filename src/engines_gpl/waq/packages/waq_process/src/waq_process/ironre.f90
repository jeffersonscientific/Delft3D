...
!
      ...
      integer(kind=int_32)  ::ipoint( 17) ! I  Array of pointers in pmsa to get and store the data
      integer(kind=int_32)  ::increm( 17) ! I  Increments in ipoint for segment loop, 0=constant, 1=spatially varying
      ...
      integer(kind=int_32)  ::ipnt( 17)   !    Local work array for the pointering
...
!
      ...
      real(kind=sp)  ::feiiipa     ! I  particulate amorphous oxidizing iron               (gFe/m3)
      real(kind=sp)  ::feiiipc     ! I  particulate crystalline oxidizing iron             (gFe/m3)
      real(kind=sp)  ::sud         ! I  total dissolved sulphide (SUD)                     (gS/m3)
      real(kind=sp)  ::frh2sdis    ! I  fraction of dissolved hydrogen sulphide            (-)
      real(kind=sp)  ::rcfeah2s20  ! I  rate of amorphous iron red. with H2S               (m3/gS/d)
      real(kind=sp)  ::rcfech2s20  ! I  rate of crystalline iron red. with H2S             (m3/gS/d)
      real(kind=sp)  ::rcfeafes20  ! I  rate of amorphous iron red. with FeS               (m3/gFe/d)
      real(kind=sp)  ::rcfecfes20  ! I  rate of crystalline iron red. with FeS             (m3/gFe/d)
      real(kind=sp)  ::tcfered     ! I  temperature coeff. for abiotic iron reduction      (-)
      ...
      real(kind=sp)  ::fire1       ! O  rate of amorphous iron red. with H2S               (gFe/m3/d)
      real(kind=sp)  ::fire2       ! O  rate of crystalline iron red. with H2S             (gFe/m3/d)
      real(kind=sp)  ::fire3       ! O  rate of amorphous iron red. with FeS               (gFe/m3/d)
      real(kind=sp)  ::fire4       ! O  rate of crystalline iron red. with FeS             (gFe/m3/d)
      real(kind=sp)  ::dire1       ! F  rate of amorphous iron red. with H2S               (gFe/m3/d)
      real(kind=sp)  ::dire2       ! F  rate of crystalline iron red. with H2S             (gFe/m3/d)
      real(kind=sp)  ::dire3       ! F  rate of amorphous iron red. with FeS               (gFe/m3/d)
      real(kind=sp)  ::dire4       ! F  rate of crystalline iron red. with FeS             (gFe/m3/d)
      integer(kind=int_32)  ::idire1      !    Pointer to the rate of amorphous iron red. with H2S
      integer(kind=int_32)  ::idire2      !    Pointer to the rate of crystalline iron red. with H2S
      integer(kind=int_32)  ::idire3      !    Pointer to the rate of amorphous iron red. with FeS
      integer(kind=int_32)  ::idire4      !    Pointer to the rate of crystalline iron red. with FeS
      real(kind=sp)  ::tffered     ! L  temperature function for abiotic iron reduction
      real(kind=sp)  ::kire1       ! L  rate of amorphous iron red. with H2S
      real(kind=sp)  ::kire2       ! L  rate of crystalline iron red. with H2S
      real(kind=sp)  ::kire3       ! L  rate of amorphous iron red. with FeS
      real(kind=sp)  ::kire4       ! L  rate of crystalline iron red. with FeS
