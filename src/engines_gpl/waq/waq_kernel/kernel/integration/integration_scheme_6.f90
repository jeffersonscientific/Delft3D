...
contains
    ...
    !! iterative methods.
    subroutine scheme_6_steady_state_hz_upwind(buffer, file_unit_list, file_name_list, action, dlwqd, gridps)
        ...
        use m_scheme_6_and_7_utils, only: fill_matrix_scheme_6
        ...
        associate (a => buffer%rbuf, j => buffer%ibuf, c => buffer%chbuf)
            ...
            ! some initialisation
            ithandl = 0
            if (timon) call timstrt("scheme_6_steady_state_hz_upwind", ithandl)
            ...
            do substance_i = 1, num_substances_transported
                ...
                call fill_matrix_scheme_6(a(idisp:), a(idiff:), a(iarea:), a(iflow:), a(ileng:), &
            ...
            ! mass balance
            iaflag = 1
            call calculate_mass_balance_steady_state(a(idisp:), a(idiff:), a(iarea:), a(iflow:), a(ileng:), &
    ...
    end subroutine scheme_6_steady_state_hz_upwind
