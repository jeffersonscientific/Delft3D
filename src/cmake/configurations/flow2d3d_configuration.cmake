...
if(NOT TARGET lapack)
    add_subdirectory(${checkout_src_root}/${lapack_module} lapack)
endif()
if(NOT TARGET blas)
    add_subdirectory(${checkout_src_root}/${blas_module} blas)
endif()
if(NOT TARGET clipper)
    add_subdirectory(${checkout_src_root}/${clipper_module} clipper)
endif()
