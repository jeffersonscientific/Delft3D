...
if (UNIX)
    if(NOT TARGET esm_create)
        add_subdirectory(${CMAKE_SOURCE_DIR}/src/${utils_lgpl_path}/esmfsm/tests/esm_create esm_create)
    endif()
    if(NOT TARGET esm_delete)
        add_subdirectory(${CMAKE_SOURCE_DIR}/src/${utils_lgpl_path}/esmfsm/tests/esm_delete esm_delete)
    endif()
    if(NOT TARGET esm_info)
        add_subdirectory(${CMAKE_SOURCE_DIR}/src/${utils_lgpl_path}/esmfsm/tests/esm_info esm_info)
    endif()
endif(UNIX)
...
if(NOT TARGET datsel)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${datsel_module} datsel)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${datsel_f_module} datsel_f)
endif()

if(NOT TARGET kubint)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${kubint_module} kubint)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${kubint_f_module} kubint_f)
endif()

if(NOT TARGET lint)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${lint_module} lint)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${lint_f_module} lint_f)
endif()

if(NOT TARGET nesthd1)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${nesthd1_module} nesthd1)
endif()

if(NOT TARGET nesthd2)
    add_subdirectory(${CMAKE_SOURCE_DIR}/src/${nesthd2_module} nesthd2)
endif()
