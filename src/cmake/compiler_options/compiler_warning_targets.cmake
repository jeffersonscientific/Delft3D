...
function(add_warnings_as_errors_post_build_windows target_name)
    ...
    add_custom_command(TARGET ${target_name}
                       POST_BUILD
                       COMMAND ${Python_EXECUTABLE} fortran_warnings_as_errors.py "${CMAKE_CURRENT_BINARY_DIR}/${target_name}.dir/$<CONFIG>/BuildLog.htm" --print-messages --project-name "${target_name}"
