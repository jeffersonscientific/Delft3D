...
ENDIF(UNIX)
IF(WIN32)
fixup_bundle("${CMAKE_INSTALL_PREFIX}/bin/delwaq1.exe" "${BUILD_LIBRARIES}" "${THIRDPARTY_x64_LIB_FOLDERS}")
fixup_bundle("${CMAKE_INSTALL_PREFIX}/bin/delwaq2.exe" "${BUILD_LIBRARIES}" "${THIRDPARTY_x64_LIB_FOLDERS}")
fixup_bundle("${CMAKE_INSTALL_PREFIX}/bin/waqmerge.exe" "${BUILD_LIBRARIES}" "${THIRDPARTY_x64_LIB_FOLDERS}")
fixup_bundle("${CMAKE_INSTALL_PREFIX}/bin/ddcouple.exe" "${BUILD_LIBRARIES}" "${THIRDPARTY_x64_LIB_FOLDERS}")
fixup_bundle("${CMAKE_INSTALL_PREFIX}/bin/agrhyd.exe" "${BUILD_LIBRARIES}" "${THIRDPARTY_x64_LIB_FOLDERS}")
fixup_bundle("${CMAKE_INSTALL_PREFIX}/bin/maptonetcdf.exe" "${BUILD_LIBRARIES}" "${THIRDPARTY_x64_LIB_FOLDERS}")
ENDIF(WIN32)
