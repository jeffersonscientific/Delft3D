...
object DIMRbak :
        BuildType({
            templates(TemplateMonitorPerformance)

            name = "Publish DIMRset"
            buildNumberPattern = "%build.vcs.number%"
            maxRunningBuilds = 1

            features { approval { approvalRules = "group:DIMR_BAKKERS:1" } }
    ...
    """.trimIndent()
        ...
        """.trimIndent()
            ...
            params {
                ...
                password(
                        "dimrbakker_password",
                        "credentialsJSON:43ca5761-31e9-4289-97f3-c060a4007293"
                )
                password(
                        "dimrbakker_personal_access_token",
                        "credentialsJSON:8af5f616-4c9b-4f2c-9cd2-b5cc8cc4592d"
                )
                param(
                        "dry_run",
                        if (DslContext.getParameter("enable_dimrbak").lowercase() == "true") "false"
                        else "true"
                )
            }
