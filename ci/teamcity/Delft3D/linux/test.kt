...
object LinuxTest : BuildType({
    ...
    params {
        ...
        checkbox("copy_cases", "true", label = "Copy cases", description = "ZIP a complete copy of the ./data/cases directory.", display = ParameterDisplay.PROMPT, checked = "true", unchecked = "false")
