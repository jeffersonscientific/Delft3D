...
call %dimrdir%\x64\dflowfm\bin\dflowfm-cli.exe --partition:ndomains=3:icgsolver=6 weirtimeseries.mdu
cd ..

call %dimrdir%\x64\dimr\scripts\run_dimr_parallel.bat 3 dimr_config.xml
